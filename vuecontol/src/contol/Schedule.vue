 ...
 * @LastEditTime: 2019-07-29 17:54:20
  ...
  methods:{
    ...
    dayTitle(index){
      ...
      if(this.statue_data_array[index].indexOf('0')>= 0 || this.statue_data_array[index].indexOf(0)>= 0){
        this.$set(this.statue_data_array,index,this.I )
        return
      }
      this.$set(this.statue_data_array,index,this.C )
    },
    /** 快速设置按钮方案： */
    dayTf(n){
      if(!this.disabled){ return}
